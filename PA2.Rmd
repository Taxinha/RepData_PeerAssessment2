...
### Cleaning the Data
The raw dataset has `r ncol(data)` columns, but for this analysis we only need the following columns: 
...
* `r plotTOTALDMG[1, "EVTYPE"]` and `r plotTOTALDMG[2, "EVTYPE"]` are the Weather Events with biggest Economical impact in the US (Property and Crop)
