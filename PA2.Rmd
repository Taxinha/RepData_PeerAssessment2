...
### Tidy Data
#### Cleanup data for the most harmful event type
...
#### Cleanup data for the most expensive event type
...
tidyDataDMG <- data[!(data$PROPDMG == 0 & data$CROPDMG == 0), ] %>%
  ...
  group_by(EVTYPE) %>%
  summarise(TOTALPRODDMG = sum(FINALPROPDMG), TOTALCROPDMG = sum(FINALCROPDMG))
